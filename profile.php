...
if(isset($update))
{
$que="update create_account set id='$id' name='$fname',password='$pass',mobile='$mob',address='$add' where email='$eid'";
	   ...
	   <div class="form-group">
           <div class="row">
              <div class="control-label col-sm-4"><h4>ID:</h4></div>
                <div class="col-sm-8">
                 <input type="text" name="pass" value="<?php echo $result['id']; ?>"class="form-control"/>
          </div>
        </div>
      </div>
          <div class="form-group">
